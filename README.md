...
| File | Contents |
|---|---|
| [architecture.md](doc/architecture.md) | System layers, file map, data flow |
| [dsp.md](doc/dsp.md) | The HM-2 signal chain and biquad math |
| [ui.md](doc/ui.md) | Shared UI panel model + raylib/LVGL renderers |
| [plugin.md](doc/plugin.md) | CLAP plugin: ABI, parameters, threading, installation |
| [audio.md](doc/audio.md) | miniaudio duplex device and callback |
| [build.md](doc/build.md) | Building, toolchains, artifacts, IDE setup |
| [bindings.md](doc/bindings.md) | The pre-generated bindings pattern (translate-c) |
| [roadmap.md](doc/roadmap.md) | What's next (CLAP GUI, ESP32/LVGL, UI polish) |
